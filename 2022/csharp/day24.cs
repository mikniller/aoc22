...
namespace Aoc._2022
{
    internal class Day24 : SolveDay2022
    {
        ...
        public override void Setup(bool p1)
        {
            ...
            height = _lines.Count() - 1;
            width = _lines[0].Count() - 1;
            ...
            for (int y = 1; y < height; y++)
            {
                ...
                {
                    var b = Blizzard.Create(x, y, _lines[y][x]);
                    if (b != null)
                    {
                        allBlizzards.Add(b);
        ...
        public void print((int x, int y) curPoint, int curState)
        {
            ...
            GetWriter().WriteLine($"Minute {curState}");
            ...
            GetWriter().WriteLine(b.ToString());
        }
