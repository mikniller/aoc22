...
internal class Day24
{
    ...
    public static List<Dictionary<(int x, int y), Blizzard>> blizzardStates;
    public static (int x, int y) startPoint = (1, 0);
    public static (int x, int y) endPoint = (6, 6);

    public static List<Blizzard> allBlizzards;
    ...
    public static void Setup(bool p1) {
        ...
        List<string> lines = util.ReadFile("day24.txt").Where(l => String.IsNullOrWhiteSpace(l) == false).ToList();
    ...
    public static int Move((int x,int y) from, (int x,int y) to, int minu) {
    ...
    public static void print((int x, int y) curPoint, int curState)
    {
    ...
    public static void FillMap(int minutes,bool doprint = false) 
    {
